...
///---Groups---///
#define GROUP_WINDOWS true  /* wether to use groups or workspaces by default */
#define WORKSPACE_DEFAULT 0 /* Defines which groups will be the fallback one */
///---Speed---///
...
///--Menus and Programs---///
static const char *menucmd[]   = { "/usr/local/bin/dmenu_run", NULL };
static const char *rofi[]     = { "/usr/bin/rofi",NULL};
...
/* For AZERTY keyboards XK_1...0 should be replaced by : */
     /* DESKTOPCHANGE(     XK_bracketright,                      0) */
     /* DESKTOPCHANGE(     XK_ampersand,                         1) */
     /* DESKTOPCHANGE(     XK_bracketleft,                       2) */
     /* DESKTOPCHANGE(     XK_braceleft,                         3) */
     /* DESKTOPCHANGE(     XK_braceright,                        4) */
     /* DESKTOPCHANGE(     XK_parenleft,                         5) */
     /* DESKTOPCHANGE(     XK_equal,                             6) */
     /* DESKTOPCHANGE(     XK_asterisk,                          7) */
     /* DESKTOPCHANGE(     XK_parenright,                        8) */
     /* DESKTOPCHANGE(     XK_plus,                              9)* */
...
static key keys[] = {
    ...
    // Switch between workspace and group behavior
    {  MOD ,              XK_s,          togglegroups,      {.i=0}},
    // hide all the groups
    {  MOD ,              XK_d,          group_hide_all,    {.i=0}},
    // Iconify the window
    /* {  MOD ,              XK_i,          hide,              {.i=0}}, */
